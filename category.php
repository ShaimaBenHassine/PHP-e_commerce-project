...
// require('controllercategory.php');
$cid=intval($_GET['cid']);
...
{
$sql=$conn->prepare("INSERT into wishlist(userId,productId) values('".$_SESSION['id']."','".$_GET['pid']."')");
$sql->execute();	
    ...
    <nav class="yamm megamenu-horizontal" role="navigation">
        ...
        <ul class="nav">
            <li class="dropdown menu-item">
			  <?php $sql=$conn->prepare("SELECT id,subcategory  from subcategory where categoryid='$cid'");
			  $sql->execute();
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active " id="grid-container">
							<div class="category-product  inner-top-vs">
								<div class="row">									
			<?php
$ret=$conn->prepare("SELECT * from products where category='$cid'");
$ret->execute();
$num=$ret->rowCount();
if($num>0)
{
