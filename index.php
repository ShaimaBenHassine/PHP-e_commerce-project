...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	if(isset($_SESSION['cart'][$id])){
		...
		$sql->execute();
		if($sql->rowCount()!=0){
		$row_p=$sql->fetch(PDO::FETCH_ASSOC);
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
	    ...
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/5.webp);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free ship-on oder over DTN. 600.00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#books" data-toggle="tab">Computer</a></li>
					<li><a href="#furniture" data-toggle="tab">TV</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
$ret=$conn->prepare("SELECT * from products");
$ret->execute();
...
?>
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					DTN.<?php echo htmlentities($row['productPrice']);?>			</span>
	...
	<div class="tab-pane" id="books">
		...
		<?php
$ret=$conn->prepare("SELECT * from products where category=10");
$ret->execute();
while($row=$ret->fetch(PDO::FETCH_ASSOC)) 
{
	# code...
	...
	<?php } ?>
		...
		<div class="tab-pane" id="furniture">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
$ret=$conn->prepare("SELECT * from products where category=9");
$ret->execute();
while($row=$ret->fetch(PDO::FETCH_ASSOC))
{
?>
...
<?php
$ret=$conn->prepare("SELECT * from products where category=8 and subCategory=19");
$ret->execute();
while($row=$ret->fetch(PDO::FETCH_ASSOC)) 
{
?>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Computers</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=$conn->prepare("SELECT * from products where category=10 and subCategory=25");
$ret->execute();
while($row=$ret->fetch(PDO::FETCH_ASSOC))
{
?>
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		...
		<div class="owl-carousel best-seller custom-carousel owl-theme outer-top-xs">
			<?php
$ret=$conn->prepare("SELECT * from products where category=7");
$ret->execute();
while($row=$ret->fetch(PDO::FETCH_ASSOC)) 
{
	# code...
								...
								<div class="row product-micro-row">
									...
									<div class="col col-xs-6">
										<div class="product-info">
											...
											<div class="product-price">	
												<span class="price">
													DTN. <?php echo htmlentities($row['productPrice']);?>
												</span>
