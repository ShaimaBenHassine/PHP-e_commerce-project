...
{
$sql=$conn->prepare("INSERT into wishlist(userId,productId) values('".$_SESSION['id']."','$pid')");
$sql->execute();
...
if(isset($_POST['submit']))
{
	...
	$review=$_POST['review'];
	$ret=$conn->prepare("INSERT into productreviews(productId,quality,price,value,name,summary,review) values('$pid','$qty','$price','$value','$name','$summary','$review')");
    $ret->execute();
}
...
<?php
$ret=$conn->prepare("SELECT category.categoryName as catname,subCategory.subcategory as subcatname,products.productName as pname from products join category on category.id=products.category join subcategory on subcategory.id=products.subCategory where products.id='$pid'");
$ret->execute();
while($rw=$ret->fetch(PDO::FETCH_ASSOC)) {
...
<div class="sidebar-widget hot-deals wow fadeInUp">
	...
	<div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-xs">
								   ...
								   <?php
$ret=$conn->prepare("SELECT * from products order by rand() limit 4 ");
$ret->execute();
while($rws=$ret->fetch(PDO::FETCH_ASSOC)) {
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									DTN. <?php echo htmlentities($rws['productPrice']);?>.00
								</span>
									
							    <span class="price-before-discount">DTN.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>					
...
<?php 
$ret=$conn->prepare("SELECT * from products where id='$pid'");
$ret->execute();
...
<?php $rt=$conn->prepare("SELECT * from productreviews where productId='$pid'");
$rt->execute();
$num=$rt->rowCount();
{
?>		
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">DTN. <?php echo htmlentities($row['productPrice']);?></span>
											<span class="price-strike">DTN.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
...
<?php $qry=$conn->prepare("SELECT * from productreviews where productId='$pid'");
$qry->execute();
while($rvw=$qry->fetch(PDO::FETCH_ASSOC))
{
?>
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs">
		...
		<?php 
$qry=$conn->prepare("SELECT * from products where subCategory='$subcid' and category='$cid'");
$qry->execute();
while($rw=$qry->fetch(PDO::FETCH_ASSOC))
{
			...
			<div class="product-price">	
				<span class="price">
					Rs.<?php echo htmlentities($rw['productPrice']);?>			</span>
										     <span class="price-before-discount">DTN.
