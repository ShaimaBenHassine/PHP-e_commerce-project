...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <?php 
$ret = $conn->prepare("SELECT * FROM ordertrackhistory WHERE orderId='$oid'");
$ret->execute();
$num=$ret->rowCount();
if($num>0)
{
   ...
   <?php  }
$st='Delivered';
   $rt = $conn->prepare("SELECT * FROM orders WHERE id='$oid'");
   $rt->execute();
   while($num=$ret->fetch(PDO::FETCH_ASSOC))
     {
     
     if($st==$num['orderStatus'])
     { ?>
   <tr><td colspan="2"><b>
