...
$sql=$conn->prepare("INSERT into orders(userId,productId,quantity) values('".$_SESSION['id']."','$qty','$val34')");
$sql->execute();
...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		$query=$conn->prepare("UPDATE users set shippingAddress='$saddress',shippingState='$sstate',shippingCity='$scity',shippingPincode='$spincode' where id='".$_SESSION['id']."'");
		$query->execute();
		if($query)
		{
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		...
		<?php
$query=$conn->prepare("SELECT * from users where id='".$_SESSION['id']."'");
$query->execute();
while($row=$query->fetch(PDO::FETCH_ASSOC))
{
?>
