...
$sql = "UPDATE products SET category='$category',subCategory='$subcat',
productName='$productname',productCompany='$productcompany',
productPrice='$productprice'
,productDescription='$productdescription',shippingCharge='$productscharge'
...
$stmt = $conn->prepare("SELECT category FROM products WHERE products.id='$pid'");
$stmt->execute();
...
?>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<?php $stmt = $conn->prepare("SELECT id , categoryName FROM category WHERE category.id='$cat'");
										$stmt->execute();
										$row=$stmt->fetch(PDO::FETCH_ASSOC);?>
											<option value="<?php echo $row['id'];?>"><?php echo $row['categoryName'];?></option> 
											<?php 
											$stmt = $conn->prepare("SELECT id , categoryName FROM category");
											$stmt->execute();
								...
								<label class="control-label" for="basicinput">Sub Category</label>
									<div class="controls">
										...
										<?php $stmt = $conn->prepare("SELECT id , subcategory FROM subcategory WHERE categoryid ='$cat_id'");
										$stmt->execute();?>
