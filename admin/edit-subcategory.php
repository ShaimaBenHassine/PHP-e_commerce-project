...
if(isset($_POST['submit']))
{
	...
	$id=intval($_GET['id']);
$sql=$conn->prepare("UPDATE subcategory set categoryid='$category',subcategory='$subcat',updationDate='$currentTime' where id='$id'");
$sql->execute();	
...
<?php
$id=intval($_GET['id']);
$query=$conn->prepare("SELECT category.id,category.categoryName,subcategory.subcategory from subcategory join category on category.id=subcategory.categoryid where subcategory.id='$id'");
$query->execute();
