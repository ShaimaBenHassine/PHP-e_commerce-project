...
{
$sql=$conn->prepare("SELECT password FROM  admin where password='".md5($_POST['password'])."' && username='".$_SESSION['alogin']."'");
$sql->execute();	
$num = $sql->rowCount();
if($num>0)
{

$sql=$conn->prepare("UPDATE admin set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
$sql->execute();
